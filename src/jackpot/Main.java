...
public class Main extends javax.swing.JFrame {
    ...
    private void jButtonPalancaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPalancaActionPerformed
        ...
        mostrarDeposito();
        jugadas = new Historial(Calendar.getInstance().getTime(), jackpot.getSaldo(), jackpot.getDeposito(), jackpot.getPremio());
        listaHistoriales.add(jugadas);
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        if (respuesta == JOptionPane.OK_OPTION) {
            //Generar XML con la información de las partidas
            XMLPartidas.generarXML(listaHistoriales, "jugadas.xml");
            this.dispose();
        } else {
            //Guardar cada partida en el ArrayList y mostrarla en la salida estándar
            int jugada = 1;
